package id.ac.poliban.mi.fauzi.simpleshoppinglist;
...
import id.ac.poliban.mi.fauzi.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.fauzi.simpleshoppinglist.EXTRA.ITEM";
